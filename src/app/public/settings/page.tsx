            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
                    ...
                    <div className="border-b pb-4">
                        ...
                        <a href="/public/settings/privacy" className="text-blue-600 hover:text-blue-800">
                    ...
                    <div className="border-b pb-4">
                        ...
                        <a href="/public/settings/help" className="text-blue-600 hover:text-blue-800">
                    ...
                    <div>
                        ...
                        <a href="/public/settings/about" className="text-blue-600 hover:text-blue-800">
